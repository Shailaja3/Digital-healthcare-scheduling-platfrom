...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
						...
						<!-- date textbox -->
						<div class="input-group" style="margin=bottom:10px;">
						<p>Doctor to consult</p>
						<select name="dropdown">
						<option value="option1">Doctor Nirmala</option>
						<option value="option2">spurthi s</option>
						<option value="option3">sharada k</option>
						</select>
						</div>
						<!-- date textbox end -->
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© stay healthy</p>
